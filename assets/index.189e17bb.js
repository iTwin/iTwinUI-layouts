...
}`,ot=()=>e(A,{title:"App",codeExample:nt,children:a(c,{children:[e(c.Header,{children:e(D,{isSlim:!0})}),e(c.SideNavigation,{children:e(H,{activeItemKey:"Model"})}),e(c.Content,{children:e("iframe",{src:"https://dev.imodeljs.org/sandbox/embed/JonGraft/iTwinUI-layouts%20demo?editorPane=Hide&headers=Hide",loading:"lazy",style:{border:"none",width:"100%",height:"100%",display:"block"},sandbox:"allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"})})]})}),rt=`import { PageLayout } from '@itwin/itwinui-layouts-react';
